...
if not robot.Valid():
    ...
    # Define the COMAU NJ 60-2.2 robot's Denavit-Hartenberg (DH) parameters in millimeters and radians
    d1 = 740         # Offset along previous Z to the common normal
    a2 = 600         # Length of the common normal
    a3 = 1200        # Length of the common normal
    d4 = 1350        # Offset along previous Z to the common normal
    d6 = 260         # Offset along previous Z to the end effector
